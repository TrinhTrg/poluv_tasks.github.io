...
<div class="mt-12 pt-8 border-t border-gray-200/60 dark:border-slate-700">
    <h3 class="text-lg font-serif italic text-gray-500 dark:text-gray-400 mb-6 text-center">{{__('analytics.summary_title')}}</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-completed rounded-3xl p-6 relative overflow-hidden flex flex-col justify-between h-40">
            ...
            <div>
                <div class="text-xs font-bold text-gray-800 uppercase tracking-widest mb-1">{{__('analytics.completed_tasks')}}</div>
                <div class="text-sm text-gray-800/80">{{__('analytics.tasks')}}</div>
            </div>
        ...
        <div class="bg-pending rounded-3xl p-6 relative overflow-hidden flex flex-col justify-between h-40">
            <div class="absolute -right-4 -top-4 text-white opacity-20 text-7xl rotate-12">?</div>
            <div>
                <div class="text-xs font-bold text-white uppercase tracking-widest mb-1">{{__('analytics.pending_tasks')}}</div>
                <div class="text-sm text-white/80">{{__('analytics.tasks')}}</div>
            </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-3xl p-6 smooth-shadow flex flex-col items-center justify-center h-40 relative overflow-hidden text-center transition-colors">
            ...
            <div class="z-10">
                <div class="text-sm font-bold text-cyan-600 dark:text-cyan-400 mb-2 uppercase tracking-wide">{{__('analytics.tasks_created')}}</div>
